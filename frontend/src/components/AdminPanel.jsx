...
function AdminPanel({ onStatusChange, session }) {
  ...
  return (
    <section className="account-panel">
      <div className="account-panel-head"><div><p className="menu-eyebrow">Admin</p><h3>Admin control center</h3><p className="account-panel-copy">Review registered users and manage platform access.</p></div><button className="secondary-button" disabled={loading} onClick={() => loadAdminData(appliedSearch)} type="button">{loading ? "Refreshing..." : "Refresh all"}</button></div>
